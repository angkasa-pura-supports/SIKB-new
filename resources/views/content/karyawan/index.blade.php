  ...
  <div class="container-fluid">
    <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Master Karyawan</h4>
      </div>
              ...
              <table id="example23" class="table table-bordered table-striped">
                ...
                @foreach ($karyawans as $value)
                  <tr>
                    ...
                    <td>
                      {!! Form::open(['route'=>['master-karyawan.destroy', $value->id], 'method'=>'DELETE']) !!}
                        <a href="{{ route('master-karyawan.edit', $value->id) }}" class="btn btn-info btn-xs">Ubah</a>
