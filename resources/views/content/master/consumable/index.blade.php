...
@section('title', 'Master Consumable')
@section('cssAssets')
  ...
  <div class="container-fluid">
    <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Master Consumable</h4>
      </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="form-actions">
              <a href="{{ route('Consumable.create') }}" class="btn btn-info"><i class="fa fa-plus-circle"></i> Data</a>
            </div>
          </div>
        </div>
        <div class="card">
                    ...
                    <tr>
                      ...
                      <td>
                        {!! Form::open(['route'=>['Consumable.destroy', $value->id], 'method'=>'DELETE']) !!}
                          <a href="{{ route('Consumable.edit', $value->id) }}" class="btn btn-info btn-xs">Ubah</a>
