                                  ...
                                  <div class="row">
                                      <div class="col-md-6">
                                          <div class="form-group{{ $errors->has('nama_bandara') ? ' has-danger' : '' }}">
                                            ...
                                            {!! Form::select('program_to_do', ['Weekly (Sun)'=>'Weekly (Sun)','Weekly (Mon)'=>'Weekly (Mon)', 'Weekly (Tue)'=>'Weekly (Tue)', 'Weekly (Wed)'=>'Weekly (Wed)', 'Weekly (Thu)'=>'Weekly (Thu)', 'Weekly (Fri)'=>'Weekly (Fri)', 'Weekly (Sat)'=>'Weekly (Sat)'], null, ['class'=>'select2 form-control custom-select', 'placeholder'=>'Masukkan sesuatu...']);!!}
                                            @if ($errors->has('routine'))
                                              <small class="form-control-feedback">
                                                {{ $errors->first('routine') }}
                                              </small>
