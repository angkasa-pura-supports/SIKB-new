...
@section('title', 'Ubah Kondisi Peralatan')
@section('cssAssets')
              ...
              <div class="col-lg-12">
                  <div class="card">
                      <div class="card-header bg-info">
                          <h4 class="m-b-0 text-white">Ubah Kondisi Peralatan</h4>
                      </div>
                      <div class="card-body">
                          {!! Form::model($data, ['route'=>['master-kondisi-peralatan.update', $data->id], 'method'=>'PUT']) !!}
                              <div class="form-body">
                                  <div class="row">
                                      <div class="col-md-6">
