...
@section('title', 'Monitoring Penggunaan Consumable')
@section('cssAssets')
  ...
  <div class="container-fluid">
    <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Monitoring Penggunaan Consumable</h4>
      </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="form-actions">
              <a href="{{ route('monitoring-penggunaan-consumable.create') }}" class="btn btn-info"><i class="fa fa-plus-circle"></i> Data</a>
            </div>
          </div>
        </div>
        <div class="card">
